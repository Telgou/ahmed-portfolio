    ...
    <div className="profile container_shadow fixed">
      ...
      <div className="profile_information">
        ...
        <div className={"button_container"}>
          <a href={language =="en" ? "https://drive.google.com/uc?export=download&id=1oPGDUzNNrBHv2v6quEYuBu-AdD7dFeQZ" : "https://drive.google.com/uc?export=download&id=15WIm9yDrd26Wa3gD1s-I57iAMs1oqbss"} download={true}>
